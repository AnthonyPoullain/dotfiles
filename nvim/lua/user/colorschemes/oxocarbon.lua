...
Theme.set_general_highlights = function(colors)
	...
	local conditional_italic = { "italic" }
	...
	highlight("Comment", 4, none, { "italic" })
	...
	highlight("Function", 9, none, { "bold" })
	highlight("Identifier", 5, none, { "bold" })
	highlight("Include", 10, none)
	highlight("Keyword", 10, none, { "bold" })
